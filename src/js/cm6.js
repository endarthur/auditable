...
const gcuDark = EditorView.theme({
  ...
  '&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection': {
    backgroundColor: 'color-mix(in srgb, var(--au-action) 25%, transparent)',
  },
  '.cm-activeLine': { backgroundColor: 'color-mix(in srgb, var(--au-action) 5%, transparent)' },
  '.cm-gutters': {
    backgroundColor: 'var(--au-surface-raised)',
  ...
  '.cm-activeLineGutter': { backgroundColor: 'color-mix(in srgb, var(--au-action) 8%, transparent)' },
  '.cm-lineNumbers .cm-gutterElement': { padding: '0 4px 0 8px' },
  '&.cm-focused': { outline: 'none' },
  '.cm-scroller': { overflow: 'auto' },
  '.cm-line': { padding: '0' },
  // match highlight
  '.cm-selectionMatch': { backgroundColor: 'color-mix(in srgb, var(--au-action) 15%, transparent)' },
  // bracket matching
  '.cm-matchingBracket': { backgroundColor: 'color-mix(in srgb, var(--au-action) 30%, transparent)', color: 'var(--au-action) !important' },
  '.cm-nonmatchingBracket': { backgroundColor: 'color-mix(in srgb, var(--au-error) 30%, transparent)' },
  // autocomplete
  '.cm-tooltip': {
    backgroundColor: 'var(--au-surface-bright)',
  ...
  '.cm-tooltip.cm-tooltip-autocomplete': {
    ...
    '& > ul > li[aria-selected]': {
      backgroundColor: 'color-mix(in srgb, var(--au-action) 20%, transparent)',
      color: 'var(--au-fg)',
    },
  },
  '.cm-completionLabel': { color: 'var(--au-fg)' },
  '.cm-completionDetail': { color: 'var(--au-fg-soft)', fontStyle: 'italic', marginLeft: '8px' },
  '.cm-completionMatchedText': { textDecoration: 'none', color: 'var(--au-action)' },
}, { dark: true });
...
const gcuLight = EditorView.theme({
  ...
  '.cm-activeLine': { backgroundColor: 'color-mix(in srgb, var(--au-action) 6%, transparent)' },
  '.cm-gutters': {
    backgroundColor: 'var(--au-surface-raised)',
    color: 'var(--au-fg-soft)',
    borderRight: '1px solid var(--au-border)',
  ...
  '.cm-activeLineGutter': { backgroundColor: 'color-mix(in srgb, var(--au-action) 10%, transparent)' },
  '.cm-lineNumbers .cm-gutterElement': { padding: '0 4px 0 8px' },
  '&.cm-focused': { outline: 'none' },
  '.cm-scroller': { overflow: 'auto' },
  '.cm-line': { padding: '0' },
  '.cm-selectionMatch': { backgroundColor: 'color-mix(in srgb, var(--au-action) 15%, transparent)' },
  '.cm-matchingBracket': { backgroundColor: 'color-mix(in srgb, var(--au-action) 30%, transparent)', color: 'var(--au-action) !important' },
  '.cm-nonmatchingBracket': { backgroundColor: 'color-mix(in srgb, var(--au-error) 20%, transparent)' },
  '.cm-tooltip': {
    backgroundColor: 'var(--au-surface-bright)',
    border: '1px solid var(--au-rule)',
    color: 'var(--au-fg-muted)',
...
const gcuHighlightDark = HighlightStyle.define([
  ...
  { tag: tags.separator, color: 'var(--au-fg-soft)' },
  { tag: tags.paren, color: 'var(--au-fg-soft)' },
  { tag: tags.brace, color: 'var(--au-fg-soft)' },
  { tag: tags.squareBracket, color: 'var(--au-fg-soft)' },
  ...
  // HTML tokens
  { tag: tags.angleBracket, color: 'var(--au-info)' },
  { tag: tags.self, color: 'var(--au-warn)' },
  { tag: tags.regexp, color: 'var(--au-warn)' },
]);
...
const gcuHighlightLight = HighlightStyle.define([
  ...
  { tag: tags.definition(tags.variableName), color: 'var(--au-fg)' },
  { tag: tags.constant(tags.variableName), color: 'var(--au-warn)' },
  { tag: tags.operator, color: 'var(--au-fg-soft)' },
  { tag: tags.punctuation, color: 'var(--au-fg-muted)' },
  { tag: tags.separator, color: 'var(--au-fg-muted)' },
  { tag: tags.paren, color: 'var(--au-fg-muted)' },
  { tag: tags.brace, color: 'var(--au-fg-muted)' },
  { tag: tags.squareBracket, color: 'var(--au-fg-muted)' },
  { tag: tags.propertyName, color: 'var(--au-info)' },
  { tag: tags.variableName, color: 'var(--au-fg)' },
  { tag: tags.typeName, color: 'var(--au-info)' },
  { tag: tags.className, color: 'var(--au-info)' },
