...
const HELP = {
  start: ['Getting started',
    ...
    + `<b>Understand & check the data</b> — <b>Σ stats</b> (toolbar) summarizes every column at once; <b>Data → Group by…</b> aggregates by domain (with weighting); <b>Data → Grade–tonnage…</b> reports tonnes · grade · metal by domain <i>and</i> the cutoff curves; <b>Data → Data quality…</b> flags silent problems (leading-zero codes, missing-value sentinels, junk in numeric columns). See <i>Analysis &amp; quality</i>.<br><br>`
