...
// the closed-loop scorer (scoreModel)
...
function fitModel(experimental, opts = {}) {
...
function scoreModel(data, model, opts = {}) {
...
function lagSupportAt(surface, az, plunge) {
...
// lagSupport, lagSupportAt — the lag-support surface L(û), drives per-direction lag selection
