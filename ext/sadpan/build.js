#!/usr/bin/env node
// Bundles ext/sadpan/src/ ES modules into a single index.js
...
const header = '// \u26a0 GENERATED FILE \u2014 DO NOT EDIT. Source: ext/sadpan/src/  Build: node ext/sadpan/build.js\n'
...
console.log(`Built ext/sadpan/index.js (${(size / 1024).toFixed(1)} KB)`);
