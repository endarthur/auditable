...
export class DMFormatError extends Error {
 ...
 */
export function detectDM(bytes) {
  const dv = toDV(bytes);
 ...
 */
export function parseHeader(bytes, fmt) {
  const dv = toDV(bytes);
...
export function recordRange(h, i) {
