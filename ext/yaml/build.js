#!/usr/bin/env node
// Bundle ext/yaml/src/ into ext/yaml/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/yaml/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
