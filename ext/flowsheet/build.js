#!/usr/bin/env node
// Bundle ext/flowsheet/src/ into ext/flowsheet/index.js — a single ES module.
// Concat strategy (like ext/sluice, ext/recon): strip import/export, concatenate
...
const files = ['hash.js', 'registry.js', 'cache.js', 'engine.js'];
...
const header = `// @gcu/flowsheet — lazy, content-addressed pipeline (lineage) engine
// Auto-generated from ext/flowsheet/src/ — do not edit directly
`;
...
console.log(`Built ext/flowsheet/index.js (${(output.length / 1024).toFixed(1)} KB, ${names.length} exports)`);
