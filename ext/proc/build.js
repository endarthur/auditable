#!/usr/bin/env node
// Bundle ext/proc/src/ into ext/proc/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/proc/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
