#!/usr/bin/env node
// Bundle ext/peel/src/ into ext/peel/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/peel/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
