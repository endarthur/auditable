#!/usr/bin/env node
// Bundle ext/units/src/ into ext/units/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/units/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
