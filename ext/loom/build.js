#!/usr/bin/env node
// Bundle ext/loom/src/ into ext/loom/index.js — a single ES module.
// Concat strategy (like ext/sluice, ext/recon, ext/flowsheet): strip
...
const files = ['model.js', 'geometry.js', 'memory-provider.js', 'render.js', 'grid.js'];
...
const header = `// @gcu/loom — virtualized canvas grid renderer (rich async cell provider)
...
console.log(`Built ext/loom/index.js (${(output.length / 1024).toFixed(1)} KB, ${names.length} exports)`);
