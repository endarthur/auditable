...
export function dhTangent(azDeg, dipDeg) {
...
export function dhDetectDipConvention(surveys) {
  let dips = [];
...
export function dhNormalizeSurveys(rawSurveys, dipConvention) {
...
export function dhPositionAt(hole, depth) {
