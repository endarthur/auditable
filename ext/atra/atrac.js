 ...
 */
export function bundleRecipe(inputs, opts = {}) {
  if (!inputs || !inputs.length) throw new Error('bundleRecipe: expected at least one .atra input');
  return bundle(inputs.map((i) => i.text).join('\n'), opts);
}
