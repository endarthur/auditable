#!/usr/bin/env node
// Bundle ext/sheet/src/ into ext/sheet/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/sheet/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
