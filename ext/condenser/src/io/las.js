...
export class LasFormatError extends Error {
...
export function decodeLasRecords(dv, header, n, recStart, { forceRgb16 = false } = {}) {
 ...
 */
export async function openLas(blob, { headerBytes = 512 } = {}) {
