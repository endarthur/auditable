#!/usr/bin/env node
// Bundles ext/ed/src/ ES modules into a single index.js
// (mirrors ext/readline/build.js).
...
const header = '// ⚠ GENERATED FILE — DO NOT EDIT. Source: ext/ed/src/  Build: node ext/ed/build.js\n'
...
console.log(`Built ext/ed/index.js (${(size / 1024).toFixed(1)} KB)`);
