#!/usr/bin/env node
// Bundle ext/ed/src/ into ext/ed/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/ed/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
