#!/usr/bin/env node
// Bundle ext/menu/src/ into ext/menu/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/menu/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
