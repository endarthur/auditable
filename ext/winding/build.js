...
// @gcu/frame is the coordinate-frame contract setMesh/evaluate speak, and the
// BVH now lives in @gcu/groma. INLINE both (collision-safe via the rename pass)
// so index.js stays a self-contained ESM.
const r = await bundle({
  at: import.meta.url,
  inline: ['../frame/src/frame.js', '../groma/src/bvh.js', '../groma/src/ray.js'],
  sourcemap: false, meta: false,
});
