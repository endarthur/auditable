#!/usr/bin/env node
// Bundle ext/plan/src/ into ext/plan/index.js via @gcu/build. Sidecars off:
...
console.log(`Built ext/plan/index.js (${(r.code.length / 1024).toFixed(1)} KB, ${r.meta.exports.length} exports)`);
